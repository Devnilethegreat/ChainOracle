# chainoracle.py
"""
Main module for ChainOracle application.
"""
...
class ChainOracleCore:
    """Core processing class for ChainOracle."""
...
class ChainOracle:
    """Main orchestrator for ChainOracle."""

    def __init__(self, verbose: bool = False):
        self.verbose = verbose
        self.threshold = float(os.getenv("THRESHOLD", "0.75"))
        self.core = ChainOracleCore(threshold=self.threshold, verbose=verbose)
    ...
    def run(self) -> bool:
        try:
            self.logger.info("Starting ChainOracle processing pipeline")
