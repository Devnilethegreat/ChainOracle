# ChainOracle: Decentralised AI data oracle with on-chain model attestation Implementation
> Advanced python solution leveraging modern architecture patterns and cutting-edge AI technology.

ChainOracle aggregates off-chain data from diverse APIs, reaches consensus via a Byzantine-fault-tolerant voting scheme, and posts tamper-evident price feeds on-chain with cryptographic attestation.

ChainOracle's key benefits include:
...
```bash
git clone https://github.com/Devnilethegreat/ChainOracle.git
cd ChainOracle
```
